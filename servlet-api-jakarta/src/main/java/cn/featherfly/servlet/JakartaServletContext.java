...
/**
 * JakartaServletContext.
 *
 * @author zhongj
 */
public class JakartaServletContext implements ServletContext {

    private jakarta.servlet.ServletContext servletContext;

    /**
     * Instantiates a new jakarta servlet context.
     *
     * @param servletContext the servlet context
     */
    public JakartaServletContext(jakarta.servlet.ServletContext servletContext) {
        super();
    ...
    public ServletContext getContext(String uripath) {
        return new JakartaServletContext(servletContext.getContext(uripath));
    }
     ...
     * @return the filter registration. dynamic
     ...
     * @return the filter registration. dynamic
     * @see ServletContext#addFilter(java.lang.String, Filter)
     */
