...
/**
 * jakartaHttpServletResponse.
 *
 * @author zhongj
 */
public class JakartaHttpServletResponse implements HttpServletResponse {

    private jakarta.servlet.http.HttpServletResponse httpServletResponse;

    /**
     * Instantiates a new jakarta http servlet response.
     *
     * @param httpServletResponse the http servlet response
     */
    public JakartaHttpServletResponse(jakarta.servlet.http.HttpServletResponse httpServletResponse) {
        super();
